      ...
      <div className="max-w-2xl mx-auto px-4 py-6">
        ...
        <AnimatePresence mode="wait">
          ...
          {step === 1 && (
            ...
            <div className="rounded-2xl p-6 space-y-5" style={{ background: "white", boxShadow: "inset 0 -3em 3em rgba(0,0,0,0.06), 0 0 0 2px rgb(190,190,190), 0.3em 0.3em 1em rgba(0,0,0,0.25)" }}>
          ...
          {step === 2 && (
            ...
            <div className="rounded-2xl p-6 space-y-4" style={{ background: "white", boxShadow: "inset 0 -3em 3em rgba(0,0,0,0.06), 0 0 0 2px rgb(190,190,190), 0.3em 0.3em 1em rgba(0,0,0,0.25)" }}>
