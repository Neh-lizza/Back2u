...
type UserProfile = {
  ...
  is_subscribed?: boolean; subscription_end?: string | null;
};
type ItemRow = {
        ...
        <div className="grid lg:grid-cols-3 gap-4 items-start">
          ...
          <div className="flex flex-col gap-4">
            ...
            <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }}
              ...
              {nearbyItems.length === 0 ? (
                ...
                <div className="divide-y divide-green-100">
                  {nearbyItems.map(item => (
                    <Link href={`/browse/${item.id}`} key={item.id}>
                      <div className="flex items-center gap-3 px-3 py-1.5 hover:bg-green-100 transition-all cursor-pointer">
              ...
              <div className="px-3 py-1.5 border-t border-green-100">
