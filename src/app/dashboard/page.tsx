...
function OnboardingModal({ onClose }: { onClose: () => void }) {
  ...
  const steps = [
    ...
    },
    {
      ...
      body: "Post a \"Found\" report. Always completely free. You earn Guardian points for helping the community.",
        ...
        <div className="grid md:grid-cols-2 gap-6 items-start">
          ...
          <div className="bg-[#0a0a0a] rounded-[2rem] p-4">
            ...
            <div className="bg-primary/10 border border-primary/30 rounded-xl p-4 mb-3 text-center">
              <p className="text-primary font-black text-4xl mb-1" style={{ fontFamily: "'Clash Grotesk', sans-serif" }}>300 XAF</p>
              <p className="text-white/40 text-[10px] font-bold uppercase tracking-widest">per year</p>
            </div>
            ...
            <div className="space-y-2">
              {[
                ...
                <div key={i} className="flex items-start gap-2 bg-white/5 border border-white/10 rounded-lg px-3 py-2">
                  ...
                  <div>
                    <p className="text-white font-bold text-[10px]">{item.label}</p>
                    <p className="text-white/30 text-[9px]">{item.sub}</p>
                  </div>
                </div>
              ))}
            </div>

            <p className="text-white/20 text-[9px] font-bold uppercase tracking-widest text-center mt-3">
            ...
            <div className="relative">
              ...
              <div className="space-y-0">
                {[
                  ...
                  { icon: Award,       title: "Honesty is rewarded",         desc: "Earn Guardian points and recovery badges." },
